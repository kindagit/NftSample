...
namespace Nethereum.XUnitEthereumClients
{
    ...
    public class EthereumClientIntegrationFixture : IDisposable
    {
        ...
        public string GethClientPath { get; set; } = @"..\..\..\..\testchain\gethclique\geth.exe";
        public string ParityClientPath { get; set; } = @"..\..\..\..\testchain\openethereumpoa\openethereum.exe";
        public string AccountPrivateKey { get; set; } = "0xd641f0d18d4555d93cae8ef54dc5cda7eb6bf2a301d1c149fecd042f3f163d61";
        public string AccountAddress { get; set; } = "0xD08BC093f4Acc6Ebe21842351DBF74273c445A00";
        public string ManagedAccountPassword { get; set; } = "password";
        public string InfuraId { get; set; } = "644f6e9ce94c48d3a342e62d994dd56b";
        public InfuraNetwork InfuraNetwork { get; set; } = InfuraNetwork.Ropsten;
        public string HttpUrl { get; set; } = "http://localhost:8545";
        public System.Numerics.BigInteger ChainId { get; set; } = 444444444500;
        ...
        {
            return new ConfigurationBuilder().AddJsonFile("appsettings.json", true).Build();
        }
